(function () {
  ...
  const translations = {
    ...
    "nav-plans": { en: "Pricing", pt: "Preços" },
    ...
    "media-close": { en: "Close", pt: "Fechar" },
    "media-prev": { en: "Previous", pt: "Anterior" },
    "media-next": { en: "Next", pt: "Próxima" },
    "media-placeholder-images": { en: "Add files to /{variant}/Images using the same filenames from media-manifest.json", pt: "Adicione arquivos em /{variante}/Images usando os mesmos nomes de media-manifest.json" },
    "media-placeholder-gifs": { en: "Add files to /{variant}/Gifs using the same filenames from media-manifest.json", pt: "Adicione arquivos em /{variante}/Gifs usando os mesmos nomes de media-manifest.json" },
    "media-placeholder-videos": { en: "Add files to /{variant}/Videos using the same filenames from media-manifest.json", pt: "Adicione arquivos em /{variante}/Videos usando os mesmos nomes de media-manifest.json" },
    ...
    "plans-title": { en: "Choose the plan that fits your workflow", pt: "Escolha o plano ideal para o seu fluxo" },
    "plans-sub": { en: "Start for free, then upgrade only if you need more power.", pt: "Comece grátis e faça upgrade apenas se precisar de mais recursos." },
    "plan-free-title": { en: "Free", pt: "Grátis" },
    "plan-free-desc": { en: "For getting started with QuickFocus.", pt: "Para começar a usar o QuickFocus." },
    "plan-free-bullet-1": { en: "Basic task management", pt: "Gerenciamento básico de tarefas" },
    "plan-free-bullet-2": { en: "Limited workspaces and projects", pt: "Workspaces e projetos limitados" },
    "plan-free-bullet-3": { en: "Core workflow access", pt: "Fluxo principal disponível" },
    "plan-free-bullet-4": { en: "No payment required", pt: "Sem pagamento" },
    "plan-free-cta": { en: "Download Free", pt: "Baixar Grátis" },
    "plan-monthly-title": { en: "Pro Monthly", pt: "Pro Mensal" },
    "plan-monthly-desc": { en: "Flexible access with a low entry cost.", pt: "Acesso flexível com baixo custo de entrada." },
    "plan-monthly-bullet-1": { en: "Full Pro features", pt: "Todos os recursos Pro" },
    "plan-monthly-bullet-2": { en: "Valid for 1 month", pt: "Válido por 1 mês" },
    "plan-monthly-bullet-3": { en: "Great for trying Pro", pt: "Ótimo para testar o Pro" },
    "plan-monthly-bullet-4": { en: "Cancel anytime", pt: "Cancelamento a qualquer momento" },
    "plan-monthly-cta": { en: "Get Monthly", pt: "Assinar Mensal" },
    "plan-yearly-title": { en: "Pro Yearly", pt: "Pro Anual" },
    "plan-yearly-desc": { en: "Lower cost over time for regular use.", pt: "Menor custo ao longo do tempo para uso frequente." },
    "plan-yearly-bullet-1": { en: "Full Pro features", pt: "Todos os recursos Pro" },
    "plan-yearly-bullet-2": { en: "Valid for 1 year", pt: "Válido por 1 ano" },
    "plan-yearly-bullet-3": { en: "Better value than monthly", pt: "Melhor valor que o mensal" },
    "plan-yearly-bullet-4": { en: "Simple annual payment", pt: "Pagamento anual simples" },
