(function () {
  ...
  const translations = {
    ...
    "media-placeholder-images": { en: "Add files to /{variant}/Images", pt: "Adicione arquivos em /{variante}/Images" },
    "media-placeholder-gifs": { en: "Add files to /{variant}/Gifs", pt: "Adicione arquivos em /{variante}/Gifs" },
    "media-placeholder-videos": { en: "Add files to /{variant}/Videos", pt: "Adicione arquivos em /{variante}/Videos" },
